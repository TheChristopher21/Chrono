...
public class User {
    ...
    private Integer expectedWorkDays; // z. B. 5 (Montag bis Freitag)

    @Column(name = "daily_work_hours")
    private Double dailyWorkHours; // z. B. 8.0 Stunden pro Tag

    @Column(name = "break_duration")
    private Integer breakDuration; // in Minuten, z. B. 60
