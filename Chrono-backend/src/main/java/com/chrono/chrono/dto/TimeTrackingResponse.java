// src/main/java/com/chrono/chrono/dto/TimeTrackingResponse.java
...
public class TimeTrackingResponse {
    ...
    public TimeTrackingResponse(Long id, LocalDateTime startTime, LocalDateTime endTime, boolean corrected, String color, Integer punchOrder) {
        this.id = id;
