...
set "FE_REPO=chrisubuntu1/chrono-frontend"
set "BE_REPO=chrisubuntu1/chrono-backend"
...
for /f "delims=" %%A in ('git rev-parse --short^=12 HEAD') do set "IMAGE_TAG=%%A"
