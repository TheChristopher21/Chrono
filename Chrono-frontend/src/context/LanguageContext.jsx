...
const translations = {
    de: {
        ...
        landing: {
            hero: {
                badge: "All-in-One Plattform für Teams in CH & DE",
                title: "Eine Plattform für Arbeitszeit, Urlaub, Lohn & Prozesse.",
                subline: "Arbeitszeit, Urlaub, Lohn und Prozesse in einem System.",
                text: "Chrono hilft Teams in der Schweiz und Deutschland, Arbeitszeiten sauber zu erfassen, Abwesenheiten zu verwalten und Löhne effizient abzurechnen - in einem einzigen System.",
                note: "Deutsche Server · Hetzner (https://www.hetzner.com/) · DSGVO-konform · Keine Kreditkarte nötig",
                proofLabel: "Kurzüberblick",
                proof1: "Deutsche Server",
                proof2: "DSGVO-konform",
                proof3: "Keine Kreditkarte nötig",
            ...
            founderTrust: {
                ...
                text: "Chrono-Logisch wird von Christopher Siefert in Mogelsberg, St. Gallen entwickelt. Ziel ist eine zentrale, verständliche und praxisnahe Plattform für Unternehmen, die Zeit, HR, Lohnprozesse, CRM, Finanzen, Lager und Reporting in einem System bündeln möchten.",
            ...
            trust: {
                ...
                serverLabel: "Hosting",
                serverValue: "Deutsche Server",
                privacyLabel: "Datenschutz",
                privacyValue: "DSGVO-konform",
                marketLabel: "Region",
                marketValue: "CH & DE ready",
                pricingLabel: "Start",
                pricingValue: "ab 5 CHF / MA",
            },
            social: {
                title: "Vertrauen von Teams aus CH & DE",
                note: "Chrono läuft auf sicheren deutschen Hetzner-Servern (https://www.hetzner.com/) und ist vollständig DSGVO-konform.",
                hotel: "Hotel",
            ...
            features: {
                kicker: "Module",
                title: "Module auf einen Blick.",
                lead: "Zeit & Team ist der Kern. Alles Weitere wird je nach Prozess dazugeschaltet.",
            ...
            steps: {
                ...
                lead: "In der Regel schnell startklar - ohne komplizierte Einführung und ohne Excel-Umwege.",
                register: {
                    title: "Registrieren",
                    text: "Konto anlegen und Grunddaten erfassen. Keine Kreditkarte nötig.",
                },
                setup: {
                    title: "Team & Bereiche einrichten",
                    text: "Mitarbeitende, Module, Arbeitsmodelle und Projekte passend konfigurieren.",
                },
                start: {
                    title: "Direkt loslegen",
                    text: "Stempeln, Urlaub verwalten, Löhne vorbereiten und Prozesse bündeln.",
                },
    ...
    en: {
        ...
        landing: {
            hero: {
                badge: "All-in-one platform for teams in CH & DE",
                title: "One platform for time, leave, payroll & processes.",
                subline: "Time, leave, payroll and processes in one system.",
                text: "Chrono helps teams in Switzerland and Germany capture working hours cleanly, manage absences and run payroll efficiently - in one single system.",
                note: "Swiss hosting · GDPR-compliant · No credit card needed",
                proofLabel: "Quick overview",
                proof1: "Swiss hosting",
                proof2: "GDPR-compliant",
                proof3: "No credit card needed",
            ...
            founderTrust: {
                ...
                text: "Chrono-Logisch is developed by Christopher Siefert in Mogelsberg, St. Gallen. The goal is a central, understandable and practical platform for companies that want to combine time, HR, payroll, CRM, finance, inventory and reporting in one system.",
            ...
            trust: {
                ...
                serverLabel: "Hosting",
                serverValue: "Swiss hosting",
                privacyLabel: "Privacy",
                privacyValue: "GDPR-compliant",
                marketLabel: "Region",
                marketValue: "CH & DE ready",
                pricingLabel: "Start",
                pricingValue: "from CHF 5 / employee",
            },
            social: {
            ...
            features: {
                ...
                lead: "Time & team are the core. Everything else is activated only when the process needs it.",
            ...
            steps: {
                ...
                lead: "Usually ready quickly - without a complicated rollout and without spreadsheet detours.",
                register: {
                    title: "Register",
                    text: "Create your account and enter the basics. No credit card needed.",
                },
                setup: {
                    title: "Set up team & areas",
                    text: "Configure employees, modules, work models and projects to match your setup.",
                },
                start: {
                    title: "Start directly",
                    text: "Clock time, manage leave, prepare payroll and bundle processes.",
                },
