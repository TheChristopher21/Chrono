...
const translations = {
    de: {
        ...
        landing: {
            hero: {
                badge: "Schweizer Software für KMU",
                title: "Arbeitszeit, Abwesenheiten und Lohnprozesse – ohne Excel-Chaos.",
                subline: "Zeiterfassung, Freigaben und Lohnvorbereitung in einem System.",
                text: "Chrono verbindet Zeiterfassung, Urlaubsfreigaben und Lohnvorbereitung in einer zentralen Plattform. Für Schweizer und deutsche Teams, persönlich eingeführt und modular erweiterbar.",
                note: "Ab CHF 5 pro Mitarbeitendem · keine Kreditkarte im Anfrageprozess · persönlich eingeführt",
                proofLabel: "Kurzüberblick",
                proof1: "Ab CHF 5 pro Mitarbeitendem",
                proof2: "Keine Kreditkarte im Anfrageprozess",
                proof3: "Entwickelt in der Schweiz",
                statsLabel: "Chrono Kennzahlen",
                stat1: "interaktive Demo",
                stat2: "zentraler Datenfluss",
                stat3: "persönlich betreut",
                photoAlt: "Christopher Siefert",
            ...
            cta: {
                try: "Kostenlose Demo anfragen",
                demo: "Interaktive Produktdemo starten",
                demoLoading: "Demo wird geöffnet …",
                requestHint: "Persönliche Freischaltung · Rückmeldung in der Regel innerhalb eines Werktags",
            },
            productMockup: {
                label: "Chrono Produktvorschau",
            },
            realMockup: {
                header: "Willkommen, Christopher",
                username: "Benutzername",
                balance: "Überstundensaldo",
                print: "Bericht drucken",
                weeklyOverview: "Wochenübersicht",
                manualPunch: "Manuelles Stempeln",
                punchButton: "Jetzt stempeln",
                ...
                worked: "Gearbeitet",
                projectBadge: "Kundenprojekt",
                floatingOneLabel: "Offene Anträge",
                floatingOneValue: "Urlaub 2 · Korrektur 1",
                floatingTwoLabel: "Wochenstatus",
                floatingTwoValue: "Saldo positiv",
            },
            adminMockup: {
                label: "Chrono Admin-Dashboard Vorschau",
                title: "Admin-Dashboard",
                loggedIn: "Eingeloggt als admin",
                command: "Befehlspalette öffnen",
                moduleUsers: "Benutzerverwaltung",
                moduleSchedule: "Dienstplan",
                modulePayroll: "Abrechnungen",
                kpiLabel: "Aktuelle Kennzahlen",
                pendingRequests: "Offene Anträge",
                pendingMeta: "Urlaub: 2 · Korrekturen: 2",
                averageOvertime: "Ø Überstundensaldo",
                averageMeta: "Grundlage: 18",
                negativeBalances: "Negative Salden",
                negativeMeta: "sarah: -00:25",
                topOvertime: "Höchster Saldo",
                topMeta: "marc",
                weekTitle: "Team-Wochenübersicht",
            ...
            mockup: {
                ...
                leaveApproved: "Urlaubsantrag genehmigt",
                payrollReady: "Lohnlauf bereit zur Freigabe",
                card1Label: "Urlaub",
                card1Value: "3 Freigaben offen",
                card2Label: "Zeiterfassung",
                card2Value: "98% komplett",
            },
            founder: {
                label: "Gründerhinweis",
                title: "Entwickelt von Christopher Siefert",
                text: "Für Unternehmen, die klare Prozesse statt Excel-Chaos wollen.",
            },
            founderTrust: {
                role: "Gründer & Entwickler von Chrono",
                kicker: "Persönlich betreut",
                title: "Entwickelt in der Schweiz - mit direktem Ansprechpartner.",
                text: "Chrono-Logisch wird von Christopher Siefert in Mogelsberg, St. Gallen entwickelt. Der Einstieg konzentriert sich auf Arbeitszeit, Abwesenheiten und Lohnvorbereitung; weitere Prozesse werden erst nach Bedarf ergänzt.",
                signal1: "Direkte Betreuung bei Demo, Einführung und Fragen",
                signal2: "Schnelle Weiterentwicklung aus echtem Kundenfeedback",
                signal3: "Unterstützung beim Wechsel aus bestehenden Programmen",
                contact: "Kontakt aufnehmen",
                about: "Über Chrono-Logisch",
            },
            trust: {
                title: "Vertrauen für den Alltag in CH & DE",
                transportLabel: "Übertragung",
                transportValue: "TLS & HSTS",
                accessLabel: "Zugriff",
                accessValue: "Rollen & Rechte",
                privacyLabel: "Datenschutz",
                privacyValue: "revDSG & DSGVO",
                exportLabel: "Daten",
                exportValue: "Export geregelt",
            },
            outcomes: {
                kicker: "Drei klare Einstiege",
                title: "Welcher Aufwand kostet Sie heute Zeit?",
                lead: "Chrono startet bei einem konkreten Problem – nicht bei einer möglichst langen Modulliste.",
                beforeLabel: "Heute",
                afterLabel: "Mit Chrono",
                time: {
                    title: "Arbeitszeit ohne Excel",
                    before: "Stunden aus Listen, Nachträgen und Rückfragen zusammensuchen.",
                    after: "Einmal erfassen und Soll/Ist, Salden sowie Korrekturen zentral prüfen.",
                },
                leave: {
                    title: "Urlaub ohne Rückfragen",
                    before: "Anträge, Resttage und Vertretungen über mehrere Kanäle klären.",
                    after: "Antrag, Übersicht und Freigabe in einem nachvollziehbaren Workflow.",
                },
                payroll: {
                    title: "Lohnvorbereitung ohne Doppelerfassung",
                    before: "Zeit- und Abwesenheitsdaten für den Lohnlauf erneut übertragen.",
                    after: "Geprüfte Daten aus demselben System für die Abrechnung weiterverwenden.",
                },
            },
            security: {
                kicker: "Sicherheit & Datenschutz",
                title: "Klare Massnahmen statt pauschaler Versprechen.",
                lead: "Für sensible Personal- und Lohndaten zählt, was technisch und vertraglich nachvollziehbar geregelt ist.",
                privacyCta: "Datenschutz ansehen",
                termsCta: "AGB & Datenexport",
                transport: {
                    title: "Verschlüsselte Übertragung",
                    text: "TLS und HSTS schützen die Verbindung zwischen Browser und Chrono.",
                },
                access: {
                    title: "Rollenbasierter Zugriff",
                    text: "Rollen, Seitenfreigaben und administrative Zugriffe werden getrennt gesteuert.",
                },
                contract: {
                    title: "Datenschutz vertraglich geregelt",
                    text: "revDSG und DSGVO werden berücksichtigt; bei Auftragsverarbeitung ist ein AVV/DPA vorgesehen.",
                },
                export: {
                    title: "Daten bleiben exportierbar",
                    text: "Der Datenexport während der Vertragslaufzeit und der Umgang nach Vertragsende sind in den AGB beschrieben.",
                },
            },
            social: {
                title: "Vertrauen von Teams aus CH & DE",
                note: "Chrono dokumentiert Datenschutz, Rollen, Datenexport und technische Schutzmassnahmen transparent.",
                hotel: "Hotel",
            ...
            features: {
                kicker: "Kern & Erweiterungen",
                title: "Vom Kernprozess zur passenden Erweiterung.",
                lead: "Zeit, Team und Freigaben bilden den Kern. Weitere Bereiche sind transparent als verfügbar oder auf Anfrage gekennzeichnet.",
                aria: "Chrono Modulübersicht",
                map: {
                    flowLabel: "Modul-Kompass",
                    flowTitle: "Erst Grundlage, dann Erweiterungen.",
                    flowText: "Zeit & Team startet den Prozess. Weitere Module nutzen dieselbe Datenbasis.",
                    facts: {
                        coreLabel: "Kern",
                        coreValue: "Zeit, Team, Rechte",
                        dataLabel: "Daten",
                        dataValue: "einmal erfassen, mehrfach nutzen",
                        addonLabel: "Add-ons",
                        addonValue: "nur aktivieren, was gebraucht wird",
                    },
                    relationLabel: "Kurzlogik",
                    relationTitle: "Was muss man verstehen?",
                    relationText: "Eine Plattform, mehrere zuschaltbare Bereiche.",
                    flow: {
                        setup: {
                            title: "Setup",
                            text: "Rechte, Modelle, Module",
                        },
                        time: {
                            title: "Zeit & Planung",
                            text: "Arbeitszeit & Abwesenheiten",
                        },
                        customer: {
                    ...
                    modules: {
                        ...
                        projects: "Kunden, Projekte & Aufgaben",
                        crm: "CRM & Marketing",
                        ...
                        companyKnowledge: "Firmenwissen",
                        chronoTwo: "Chrono 2.0",
                        pms: "Hotelmanagement (PMS)",
                    },
                    status: {
                        base: "Basis",
                        available: "Verfügbar",
                        onRequest: "Auf Anfrage",
                        finalDevelopment: "In finaler Entwicklungsphase",
                    },
                    notes: {
                        user: "User",
                        admin: "Admin",
                    ...
                    relations: {
                        one: "Setup legt Rechte, Arbeitsmodelle und aktive Module fest.",
                        two: "Zeitdaten werden geprüft und direkt weiterverwendet.",
                        three: "Projekte, Lohn, CRM und Supply Chain nutzen dieselbe Datenbasis.",
                    },
                },
                real: {
                    dashboard: {
                        label: "Dashboard",
                        title: "Zeiterfassung & Wochenübersicht",
                        text: "Echtes User-Dashboard mit Stempeln, Soll/Ist, Wochensaldo, Tageskarten und Korrekturen.",
                    },
                    users: {
                        label: "Team & Rechte",
                        title: "Benutzerverwaltung",
                        text: "Mitarbeitende, Rollen, freigegebene Seiten und Arbeitsmodelle verwalten.",
                    },
                    schedule: {
                        label: "Planung",
                        title: "Dienstplan",
                        text: "Schichten planen, Wochen drucken und Einsatzzeiten sauber vorbereiten.",
                    },
                    payslips: {
                        label: "Abrechnung",
                        title: "Abrechnungen",
                        text: "Lohnabrechnungen und Dokumente für Mitarbeitende bereitstellen.",
                    },
                    projects: {
                        label: "Kundenarbeit",
                        title: "Kunden, Projekte & Aufgaben",
                        text: "Kunden, Projekte und Aufgaben mit gebuchten Zeiten verbinden.",
                    },
                    accounting: {
                        label: "Buchhaltung",
                        title: "Finanzbuchhaltung",
                        text: "Belege, Buchungen und Exporte für die Finanzprozesse bündeln.",
                    },
                    banking: {
                        label: "Banking",
                        title: "Zahlungsverkehr",
                        text: "Zahlungen vorbereiten, prüfen und für Banking-Prozesse freigeben.",
                    },
                    crm: {
                        label: "Pipeline",
                        title: "CRM & Marketing",
                        text: "Leads, Kundenkontakte und Pipeline im CRM-Modul führen.",
                    },
                    supply: {
                        label: "Lager",
                        title: "Supply Chain",
                        text: "Bestände, Warenbewegungen, Einkauf, Verkauf und Service im Blick behalten.",
                    },
                    knowledge: {
                        label: "Wissen",
                        title: "Firmenwissen",
                        text: "Dokumente, Richtlinien und internes Wissen zentral bereitstellen.",
                    },
                    chronoTwo: {
                        label: "Zusatzmodul",
                        title: "Chrono 2.0",
                        text: "Zusätzliche Chrono-Prozesse und neue Funktionen als eigenes Modul.",
                    },
                    settings: {
                        label: "Setup",
                        title: "Firmeneinstellungen",
                        text: "Firmendaten, Modulzugriffe und globale Einstellungen pflegen.",
                    },
                },
                tracking: {
                    label: "Kernmodul",
                    ...
                    text: "Stempeln per Browser, NFC oder App - direkt auf Kunde, Projekt oder Auftrag.",
                },
                leave: {
                    label: "Freigaben",
                    ...
                    text: "Anträge, Resttage, Krankheit und Überzeit in einem klaren Workflow.",
                },
                payroll: {
                    label: "CH & DE",
                    title: "Lohn & Finanzen",
                    ...
                    text: "Lohnläufe vorbereiten, prüfen und sauber exportieren.",
                },
                reporting: {
                    label: "Auswertung",
                    title: "Berichte",
                    ...
                    text: "Soll/Ist, Überstunden und Abwesenheiten auf einen Blick.",
                },
                teamwork: {
                ...
                reminders: {
                    ...
                    text: "Fehlende Zeiten, Erinnerungen und Freigaben laufen zusammen.",
                },
                security: {
                    label: "Sicher",
                    title: "Sicherheit",
                    line1: "Alle Infos liegen sicher auf deutschen Hetzner-Servern.",
                    line2: "Sie bestimmen, wer was sehen darf.",
                    text: "Rollen, Rechte und Datenzugriff sauber getrennt.",
                },
                access: {
                    label: "Mobil",
                    title: "Mobil nutzbar",
                    ...
                    text: "Chrono läuft im Büro, unterwegs, am Tablet und auf dem Smartphone.",
                },
                visual: {
                    clock: "Stempeln",
                    approval: "Freigabe",
                    payroll: "Lohn",
                    clockedToday: "heute gestempelt",
                    completeTimes: "Zeiten vollständig",
                    openApprovals: "3 Freigaben offen",
                    payrollRun: "Lohnlauf März",
                    readyReview: "Bereit zur Prüfung",
                    expectedShort: "Soll",
                    actualShort: "Ist",
                    absences: "Abwesenheiten",
                    missingTime: "Fehlende Zeit",
                    reminder: "Erinnerung",
                    admin: "Admin",
                    manager: "Manager",
                    employee: "Mitarbeiter",
                    mobilePunch: "Stempeln",
                    users: "Mitarbeitende",
                    active: "aktiv",
                    roles: "Rollen",
                    permissions: "Rechte",
                    pages: "Freigegebene Seiten",
                    visible: "sichtbar",
                    earlyShift: "Frühdienst",
                    lateShift: "Spätdienst",
                    print: "Drucken",
                    weekPlan: "Dienstplan",
                    payrollMonth: "Abrechnung März",
                    ready: "bereit",
                    ...
                    saturdayShort: "Sa",
                    sundayShort: "So",
                    roleMix: "Admin / Team / User",
                    openPayments: "2 offen",
                    stockItems: "12 Artikel",
                    ai: "KI",
                },
                ctaTitle: "Chrono wächst mit Ihrem Unternehmen.",
                ctaText: "Starten Sie mit dem Kern aus Zeit, Team und Rechten - und schalten Sie danach genau die Prozessbereiche frei, die Ihr Unternehmen wirklich nutzt.",
                modulesCta: "Alle Module ansehen",
            },
            showcase: {
                kicker: "Produktgefühl",
                title: "So sieht Chrono im Alltag aus.",
                lead: "Nicht nur Text: Chrono führt Zeit, Abwesenheiten, Lohn und operative Prozesse in einer gemeinsamen Oberfläche zusammen.",
                time: {
                    title: "Zeiterfassung",
                    text: "Stempeln, Korrekturen und Kundenzeiten in einem klaren Tagesfluss.",
                    status: "Heute",
                    detail: "38 Mitarbeitende aktiv",
                },
                leave: {
                    title: "Urlaub",
                    text: "Anträge, Resttage und Abwesenheiten sofort sichtbar für Team und Admin.",
                    status: "Freigaben",
                    detail: "3 Anträge offen",
                },
                payroll: {
                    title: "Lohn & Finanzen",
                    text: "Lohnläufe, Export und Buchhaltung näher am operativen Alltag.",
                    status: "Lohnlauf",
                    detail: "bereit zur Prüfung",
                },
                week: {
                    title: "Wochenübersicht",
                    text: "So sieht der echte Tagesfluss im User-Dashboard aus: Stempelzeiten, Soll/Ist und Tageskarte.",
                },
                corrections: {
                    title: "Korrekturen",
                    text: "Korrekturanträge erscheinen im Dashboard als eigener Verlauf mit Status und Detailansicht.",
                },
            },
            dashboardPreview: {
                actual: "Ist-Zeit",
                ...
                balance: "Wochensaldo",
                monday: "Montag, 27.04.",
                worked: "08:25 gearbeitet",
                clockIn: "Einstempeln",
                clockOut: "Ausstempeln",
                correctionButton: "Korrektur beantragen",
                correctionPanel: "Korrekturanträge",
                openCorrections: "2 offen",
                pending: "Offen",
                approved: "Genehmigt",
                correctionOne: "Ausstempeln 16:44 auf 17:01 ändern",
                correctionTwo: "Vergessene Mittagspause ergänzt",
                vacationMonth: "April 2026",
                openVacation: "1 Antrag offen",
                vacationRequest: "Urlaub 02.05. - 03.05.",
                inReview: "in Prüfung",
                tag: "wie im Dashboard",
            },
            steps: {
                kicker: "Start",
                title: "So starten Sie mit Chrono.",
                lead: "Transparent von der Anfrage bis zum eingerichteten Zugang.",
                register: {
                    title: "Bedarf konfigurieren",
                    text: "Teamgrösse und gewünschte Bereiche auswählen. Noch entsteht kein automatischer Account.",
                },
                setup: {
                    title: "Zugang persönlich einrichten",
                    text: "Wir prüfen die Angaben, klären Rückfragen und stellen das passende Setup bereit.",
                },
                start: {
                    title: "Mit dem Team starten",
                    text: "Nach der Freischaltung Zeit erfassen, Abwesenheiten freigeben und Daten weiterverwenden.",
                },
                link: "Demo anfragen",
            },
            calculator: {
                kicker: "Aufwand sichtbar machen",
                title: "Was kostet Ihre heutige Administration?",
                text: "Vergleichen Sie Ihren geschätzten monatlichen Verwaltungsaufwand mit dem Chrono-Basispaket.",
                employees: "Mitarbeitende",
                minutes: "Admin-Minuten pro Person/Woche",
                rate: "Interner Stundensatz (CHF)",
                currentCost: "Geschätzter heutiger Aufwand",
                chronoCost: "Chrono Basis ab",
                hours: "Std./Monat",
                perMonth: "pro Monat",
                difference: "Rechnerische Differenz",
                disclaimer: "Orientierungswert, keine Einspargarantie. Zusatzmodule und Einführungsaufwand sind nicht berücksichtigt.",
            },
            pms: {
                kicker: "Neu · In finaler Entwicklungsphase",
                heroBadge: "PMS neu",
                heroStatus: "In finaler Entwicklungsphase",
                title: "Chrono Hotelmanagement (PMS)",
                text: "Das neue PMS bündelt Reservierungen, Zimmerbelegung, Gästedaten, Housekeeping und Abrechnung in Chrono. Die Kernfunktionen stehen – aktuell bereiten wir das System gemeinsam mit Pilotbetrieben auf den produktiven Hoteleinsatz vor.",
                benefit1: "Reservierungen, Anreisen und Abreisen zentral steuern",
                benefit2: "Zimmerstatus und Housekeeping live koordinieren",
                benefit3: "Gäste, Leistungen und Rechnungen ohne Medienbruch verwalten",
                benefit4: "Persönliche Begleitung und direkter Einfluss als Pilotbetrieb",
                contactCta: "PMS als Pilotbetrieb testen",
                registerCta: "PMS-Modul konfigurieren",
                note: "Pilotplätze sind begrenzt und werden persönlich abgestimmt.",
                contactPrefill: "Ich interessiere mich für einen Pilotzugang zum Chrono Hotelmanagement (PMS) und möchte das System mit meinem Hotel testen.",
                previewLabel: "Vorschau des PMS-Dashboards",
                previewEyebrow: "Hotelbetrieb heute",
                previewTitle: "Front Office Übersicht",
                previewStatus: "Pilot",
                arrivals: "Anreisen",
                today: "heute",
                ...
                departure: "Abreise 11:00",
                cleaning: "Reinigung",
                arrival: "Anreise 15:00",
                ready: "Bereit",
                priceLabel: "Einführungspreis",
                price: "CHF 249",
                priceUnit: "pro Hotel / Monat, exkl. MwSt.",
            },
            pricing: {
                kicker: "Preise",
                title: "Modular ab 5 CHF pro Mitarbeitendem.",
                text: "Sie zahlen nur für die Bereiche, die Ihr Unternehmen wirklich braucht. Weitere Module für Urlaub, Lohn, CRM oder Supply Chain lassen sich später ergänzen.",
                cta: "Preise ansehen & Konfiguration starten",
                cardEyebrow: "Startpaket",
                badge: "Beliebter Einstieg",
                cardPrice: "ab 5 CHF",
                cardUnit: "pro Mitarbeitendem / Monat",
                note: "Ideal für kleine Teams, monatlich skalierbar.",
                cardCta: "Konfiguration starten",
                modules: {
                    time: "Zeiterfassung",
                    leave: "Urlaub",
                    projects: "Projekte",
                    payroll: "Lohn optional",
                    crm: "CRM / Supply Chain optional",
                    pms: "Hotelmanagement (PMS) optional",
                },
            },
            faq: {
                kicker: "Chrono-Logisch",
                title: "Kurz erklärt.",
                lead: "Die wichtigsten Begriffe rund um Chrono-Logisch und den fokussierten Einstieg.",
                what: {
                    question: "Was ist Chrono-Logisch?",
                    answer: "Chrono-Logisch ist eine Schweizer Unternehmensplattform für Arbeitszeit, Abwesenheiten und Lohnvorbereitung. Weitere Bereiche werden modular nach Bedarf ergänzt.",
                },
                spelling: {
                    question: "Wird Chrono-Logisch auch \"Chrono logisch\" geschrieben?",
                    answer: "Ja. Viele suchen nach \"Chrono logisch\" oder \"chrono logisch\". Die offizielle Schreibweise ist Chrono-Logisch.",
                },
            },
            contact: {
                kicker: "Demo & Kontakt",
                title: "Lassen Sie uns über Ihr Unternehmen sprechen.",
                text: "Sie möchten Chrono zuerst sehen oder haben Fragen zur Einführung, Migration oder Lohnabrechnung in CH/DE? Schreiben Sie uns - wir melden uns in der Regel noch am selben Werktag.",
                ...
                hint: "Antwort meist am selben Werktag.",
                signalsLabel: "Kontakt Vorteile",
                signal1: "Antwort meist am selben Werktag",
                signal2: "Live-Demo mit echtem Workflow",
                signal3: "Fokus auf Teams in CH & DE",
            ...
            footer: {
                ...
                linkedinLabel: "Christopher Siefert auf LinkedIn",
                instagramLabel: "Chrono auf Instagram",
            },
        ...
        registration: {
            success: {
                ...
                note: "Wenn du in der Zwischenzeit Fragen hast, erreichst du uns unter siefertchristopher@chrono-logisch.ch oder +41 76 546 79 60.",
            ...
            modules: {
                ...
                pms: {
                    ...
                    description: "Reservierungen, Zimmer, Gäste, Housekeeping und Abrechnung zentral verwalten. Für den ersten Hotelbetrieb; Pilotkunden werden während der finalen Entwicklungsphase persönlich begleitet.",
                },
            },
            pricing: {
                title: "Preisübersicht",
                billingPeriodLabel: "Abrechnung",
                billingPeriodAria: "Abrechnungszeitraum auswählen",
                monthly: "Monatlich",
                yearly: "Jährlich",
                yearlyPromo: "Bei jährlicher Zahlung ist der erste Monat gratis.",
                countryHint: "Preise für {{country}}",
                perEmployeeShort: "{{price}} / MA",
                flatShort: "{{price}} / Monat",
                perEmployeeShortMonthly: "{{price}} / MA / Monat",
                flatShortMonthly: "{{price}} / Monat",
                perEmployeeShortYearly: "{{price}} / MA / Jahr",
                flatShortYearly: "{{price}} / Jahr",
                perEmployeeDetail: "{{price}} × {{count}} MA",
                flatDetail: "{{price}} / Monat",
                perEmployeeDetailMonthly: "{{price}} × {{count}} MA",
                flatDetailMonthly: "{{price}} / Monat",
                perEmployeeDetailYearly: "{{price}} × {{count}} MA × {{months}} Monate",
                flatDetailYearly: "{{price}} × {{months}} Monate",
                total: "Gesamt pro Monat",
                totalMonthly: "Gesamt pro Monat",
                totalYearly: "Gesamt pro Jahr",
                disclaimer: "Alle Preise exkl. MwSt.",
                onRequest: "Preis auf Anfrage",
                onRequestDetail: "Preise für dieses Land auf Anfrage.",
            },
            contact: {
                ...
                phonePlaceholder: "+41 76 546 79 60",
        ...
        // ----------------------------------------------------------------------
        adminDashboard: {
            titleWeekly: "Admin-Dashboard (Wochenansicht)",
            ...
            nextWeek: "Nächste Woche",
            currentWeek: "Aktuelle Woche",
            weekTabLabel: "Wochenansicht",
            monthTabLabel: "Monatsansicht",
            weekView: {
                allOptedOutWarning: "Alle bekannten Benutzer sind derzeit von den Zeitübersichten ausgeschlossen. Passe die Einstellung \"In Zeiterfassung anzeigen\" in der Benutzerverwaltung an, um diese Ansicht wieder zu füllen.",
                actualThroughToday: "Ist (bis heute)",
                expectedThroughToday: "Soll (bis heute)",
                balanceThroughToday: "Saldo (bis heute)",
                balanceOpen: "Saldo (noch offen)",
                currentHint: "Laufende Woche: Ist, Soll und Saldo werden nur bis heute berechnet.",
                futureHint: "Diese Woche liegt in der Zukunft und hat deshalb noch keinen Saldo.",
            },
            ...
            vacationCalendarAria: "Abwesenheitskalender Übersicht",
            forDate: "",
            ...
            originalTimeLabel: "Gestempelt",
            requestedTimeLabel: "Beantragt",
            noOriginalTimeLabel: "Kein ursprünglicher Stempel",
            ...
            commandPalette: {
                buttonLabel: "Befehle (Strg+K)",
                placeholder: "Befehl suchen …",
                empty: "Keine Treffer",
                openVacations: "Urlaubscenter öffnen",
                openCorrections: "Korrekturcenter öffnen",
                jumpToday: "Zu aktueller Woche springen",
                fixLowRisk: "Offene ≤15 Min fixen",
                focusUser: "User {{name}} fokussieren",
            },
            shortcutCheatsheet: "Shortcuts: J/K=Zeile · O=Öffnen · A=Approve · D=Deny · B=Bulk-Select · /=Suche · G G=Heute · H/L=Woche ±",
            summary: {
                ariaLabel: "Aktueller Admin-Überblick",
            },
            inboxSummary: {
                title: "Statusübersicht",
                subtitle: "Was heute besondere Aufmerksamkeit benötigt.",
                total: "Offene Gesamtanzahl",
                pendingLabel: "Offene Vorgänge",
                pendingDescription: "Alles, was deine Entscheidung benötigt.",
                vacationsLabel: "Urlaubsanträge",
                vacationsDescription: "Abwesenheiten im Blick behalten.",
                correctionsLabel: "Korrekturanträge",
                correctionsDescription: "Zeitkorrekturen schnell abgleichen.",
            },
            inbox: {
                saveViewPrompt: "Ansicht speichern als…",
                views: {
                    pending: "Alle offen",
                    pendingHint: "Urlaub + Korrekturen · Status offen",
                    vacations: "Urlaubscenter",
                    vacationsHint: "Nur Urlaubsanträge anzeigen",
                    corrections: "Korrekturcenter",
                    correctionsHint: "Nur Korrekturanträge anzeigen",
                    lowRisk: "≤15 Min Low-Risk",
                    lowRiskHint: "Schnell genehmigbare Änderungen",
                    myDepartment: "Meine Abteilung",
                    myDepartmentHint: "Filter auf eigenes Team setzen",
                    approved: "Genehmigt",
                    approvedHint: "Historie genehmigter Anträge",
                    denied: "Abgelehnt",
                    deniedHint: "Abgelehnte Anträge im Blick behalten",
                },
            },
            kpis: {
            ...
            actionStream: {
                ...
                emptyRow: "Keine Elemente",
                searchPlaceholder: "Suche (Benutzer, Grund, Datum)…",
                bulkApprove: "Auswahl genehmigen",
                bulkDeny: "Auswahl ablehnen",
                approveLowRisk: "Low-Risk genehmigen",
                lowRisk: "Low Risk",
                noLowRisk: "Keine Low-Risk-Korrekturen gefunden.",
                ...
                selectRow: "Element auswählen",
                noDate: "Kein Datum",
                summary: {
                    pending: "{{count}} offen",
                    vacations: "{{count}} Urlaub",
                    corrections: "{{count}} Korrekturen",
                },
            },
            ...
            bulkDone: "{{count}} Anträge verarbeitet",
            ...
            onSickLeave: "Krank gemeldet",
            sickWithEntries: "Zeiten vorhanden – bitte prüfen.",
            halfDayNote: "Halbtägiger Urlaub – Restzeiten prüfen.",
            monthView: {
                modeLabel: "Zeitraum-Modus",
                modeCalendar: "Kalendermonat",
                modeCustomCycle: "Benutzerdefinierte Monatsgrenzen",
                modeManual: "Manuell wählen",
                customStartLabel: "Starttag im Monat",
                startLabel: "Startdatum",
                endLabel: "Enddatum",
                resetRange: "Monatsgrenzen zurücksetzen",
                currentRangeTitle: "Aktueller Zeitraum",
                noRangeSelected: "Bitte gültigen Zeitraum auswählen.",
                customCycleHint: "Automatischer Zeitraum: ab dem {day}. eines Monats bis zum Vortag des Folgemonats.",
                manualHint: "Manueller Zeitraum – Start und Ende bleiben unverändert, bis erneut angepasst.",
                adjustHint: "Standard: 1. bis letzter Tag des Monats. Wähle „Benutzerdefinierte Monatsgrenzen“ oder „Manuell“, um z. B. vom 26. bis 26. auszuwerten.",
                invalidRange: "Bitte wählen Sie einen gültigen Zeitraum.",
                noUserData: "Keine Benutzerdaten für diesen Zeitraum.",
                actualHours: "Ist (Zeitraum)",
                expectedHours: "Soll (Zeitraum)",
                balanceRange: "Saldo (Zeitraum)",
            },
            correctionModal: {
                ...
                hint: "Enter bestätigt · Shift+Enter für neue Zeile · Esc schließt",
            },
        },
        adminAnalytics: {
        ...
        adminVacation: {
            ...
            multiPeriodHint: "Zeitraum im Kalender wählen. Für Urlaub in weiteren Monaten zusätzliche Zeiträume vormerken und gemeinsam speichern.",
            periodsSaved: "Gespeicherte Zeiträume: {{count}}. Du kannst direkt weitere Urlaube eintragen.",
            periodsPartiallySaved: "Gespeicherte Zeiträume: {{count}}. Die übrigen Zeiträume bleiben zum erneuten Speichern vorgemerkt.",
            overlappingPeriods: "Dieser Zeitraum überschneidet sich mit einem vorgemerkten Urlaub.",
            halfDayOneDay: "Halbtags Urlaub ist nur für einen einzelnen Tag möglich.",
            legendSaved: "Bereits eingetragen",
            legendQueued: "Vorgemerkt",
            addPeriod: "+ Weiteren Zeitraum vormerken",
            queuedPeriods: "Vorgemerkte Zeiträume",
            removePeriod: "Zeitraum entfernen",
            savePeriods: "Zeiträume speichern",
            refreshError: "Änderung gespeichert. Die Übersicht konnte noch nicht aktualisiert werden.",
            delete: {
        ...
        payslips: {
            ...
            deleteApprovedError: "Freigegebene Abrechnungen können nicht gelöscht werden. Bitte zuerst zurückziehen.",
            deleteError: "Die Abrechnung konnte nicht gelöscht werden.",
            ...
            overtimeHours: "Überstunden (Std:Min.)",
            invalidOvertimeTime: "Bitte die Überstunden als Stunden:Minuten eingeben, zum Beispiel 16:41.",
            billedOvertime: "Abgerechnete Überstunden",
            hoursUnit: "Std.",
        ...
        impressumPage: {
            title: "Impressum",
            kicker: "Kontakt & Anbieter",
            lead: "Hier finden Sie die offiziellen Angaben zu Chrono-Logisch, klar aufbereitet und schnell erreichbar fuer Fragen rund um Angebot, Kontakt und Verantwortlichkeit.",
            updatedTag: "Rechtlicher Stand: Mai 2025",
            contactTag: "Antwort per E-Mail oder Telefon",
            locationTag: "Firmensitz in Mogelsberg, Schweiz",
            introLabel: "Auf einen Blick",
            introText: "Wenn Sie Fragen zu Chrono, zur Zusammenarbeit oder zu rechtlichen Angaben haben, finden Sie hier die wichtigsten Kontakt- und Anbieterinformationen klar strukturiert.",
            providerEyebrow: "Unternehmen",
            providerTitle: "Anbieter",
            contactEyebrow: "Erreichbarkeit",
            contactTitle: "Direkter Kontakt",
            responsibleEyebrow: "Inhalt",
            responsibleTitle: "Verantwortlich fuer den Inhalt",
            liabilityEyebrow: "Hinweis",
            liabilityTitle: "Haftungsausschluss",
            copyrightEyebrow: "Schutzrechte",
            copyrightTitle: "Urheberrecht",
            quickContactKicker: "Schneller Draht",
            quickContactTitle: "Am liebsten direkt",
            quickContactText: "Bei Fragen zu Chrono, Partnerschaften oder allgemeinen Anliegen antworten wir am schnellsten per E-Mail oder Telefon.",
            ...
            responsible: "Verantwortlich fuer den Inhalt dieser Website: <br />Christopher Siefert (Inhaber)",
            liability: "<strong>Haftungsausschluss:</strong><br />Fuer die Inhalte externer Links uebernehmen wir keine Haftung. Fuer den Inhalt der verlinkten Seiten sind ausschliesslich deren Betreiber verantwortlich.",
            copyright: "<strong>Copyright:</strong><br />Saemtliche Inhalte (Texte, Bilder, Grafiken) auf dieser Website sind urheberrechtlich geschuetzt. Jegliche Nutzung ohne ausdrueckliche Zustimmung ist untersagt.",
            responseTitle: "Rueckmeldung",
            responseText: "Wir melden uns in der Regel so schnell wie moeglich zurueck und kuemmern uns persoenlich um Ihr Anliegen.",
            noteTitle: "Transparenz",
            noteText: "Dieses Impressum stellt die gesetzlich erforderlichen Informationen bereit und wird bei relevanten Aenderungen aktualisiert.",
        ...
        privacyPage: {
            ...
            content: `
                ...
                <strong>Telefon:</strong> <a href="tel:+41765467960">+41 76 546 79 60</a></p>
        ...
        agbPage: {
            title: "Allgemeine Geschäftsbedingungen (AGB) für die SaaS-Plattform „Chrono“",
            kicker: "Rechtliches & Vertrauen",
            lead: "Klare Rahmenbedingungen für Nutzung, Datenschutz, Support und Abrechnung von Chrono.",
            updated: "Stand: 10. September 2025",
            summaryHint: "Kurzüberblick & Kernpunkte",
            highlightTitle: "Wichtig auf einen Blick",
            highlight1: "Testphasen enden automatisch – kostenpflichtig nur bei aktiver Wahl.",
            highlight2: "Zugang kann bei Zahlungsverzug, Missbrauch oder Sicherheitsrisiken gesperrt werden.",
            highlight3: "Datenexport jederzeit; nach Vertragsende 30 Tage Aufbewahrung, dann Löschung.",
            highlight4: "Schweizer Recht, Gerichtsstand ist der Sitz des Anbieters.",
            contactTitle: "Fragen?",
            contactText: "Schreib uns per E-Mail oder Ticketsystem – wir melden uns schnellstmöglich.",
            content: `
                <p class="legal-section legal-updated"><strong>Stand: 10. September 2025</strong></p>
                <ol>
                    <li>
                    ...
                    <li>
                        <div class="legal-section">
                            ...
                            <ul>
                                ...
                                <li>Urlaubs- und Abwesenheitsmanagement</li>
                                <li>optional: Lohnlauf/Lohnabrechnung</li>
                                <li>optional: CRM-, Supply-Chain- und Lagerfunktionen</li>
                            </ul>
                            <p>Der genaue Funktionsumfang ergibt sich aus dem jeweils gebuchten Paket. Der Anbieter ist berechtigt, Funktionen zu ändern, zu erweitern oder einzuschränken, sofern die wesentliche Kernfunktionalität erhalten bleibt und die Änderungen für den Kunden zumutbar sind.</p>
                        </div>
                    </li>
                    <li>
                        <div class="legal-section">
                    ...
                    <li>
                        <div class="legal-section">
                            ...
                            <ul>
                                ...
                                <li>Dritten unberechtigten Zugang zu gewähren,</li>
    ...
    en: {
        ...
        landing: {
            hero: {
                badge: "Swiss software for SMEs",
                title: "Time, absences and payroll workflows — without spreadsheet chaos.",
                subline: "Time tracking, approvals and payroll preparation in one system.",
                text: "Chrono connects time tracking, leave approvals and payroll preparation in one central platform. For Swiss and German teams, personally onboarded and modularly expandable.",
                note: "From CHF 5 per employee · no credit card in the request flow · personal onboarding",
                proofLabel: "Quick overview",
                proof1: "From CHF 5 per employee",
                proof2: "No credit card in the request flow",
                proof3: "Built in Switzerland",
                statsLabel: "Chrono metrics",
                stat1: "interactive demo",
                stat2: "central data flow",
                stat3: "personal support",
                photoAlt: "Christopher Siefert",
                aboutTitle: "About me",
                aboutText: "I built Chrono so teams can organize time clearly, fairly and effortlessly - with a focus on Switzerland.",
            },
            cta: {
                try: "Request a free demo",
                demo: "Start interactive product demo",
                demoLoading: "Opening demo …",
                requestHint: "Personal activation · usually a reply within one business day",
            },
            productMockup: {
                label: "Chrono product preview",
            },
            realMockup: {
                header: "Welcome, Christopher",
                username: "Username",
                balance: "Overtime balance",
                print: "Print report",
                weeklyOverview: "Weekly overview",
                manualPunch: "Manual punch",
                punchButton: "Punch now",
                ...
                clockOut: "Clock out",
                worked: "Worked",
                projectBadge: "Customer project",
                floatingOneLabel: "Open requests",
                floatingOneValue: "Leave 2 · Correction 1",
                floatingTwoLabel: "Week status",
                floatingTwoValue: "Positive balance",
            },
            adminMockup: {
                label: "Chrono admin dashboard preview",
                title: "Admin dashboard",
                loggedIn: "Signed in as admin",
                command: "Open command palette",
                moduleUsers: "User management",
                moduleSchedule: "Scheduling",
                modulePayroll: "Payroll",
                kpiLabel: "Current metrics",
                pendingRequests: "Open requests",
                pendingMeta: "Leave: 2 · Corrections: 2",
                averageOvertime: "Avg. overtime balance",
                averageMeta: "Based on: 18",
                negativeBalances: "Negative balances",
                negativeMeta: "sarah: -00:25",
                topOvertime: "Highest balance",
                topMeta: "marc",
                weekTitle: "Team weekly overview",
            ...
            mockup: {
                ...
                payrollReady: "Payroll run ready for approval",
                card1Label: "Leave",
                card1Value: "3 approvals open",
                card2Label: "Time tracking",
                card2Value: "98% complete",
            },
            founder: {
                label: "Founder note",
                title: "Built by Christopher Siefert",
                text: "For companies that want clear processes instead of spreadsheet chaos.",
            },
            founderTrust: {
                role: "Founder & developer of Chrono",
                kicker: "Personally supported",
                title: "Built in Switzerland - with a direct point of contact.",
                text: "Chrono-Logisch is developed by Christopher Siefert in Mogelsberg, St. Gallen. The starting point focuses on time, absences and payroll preparation; other workflows are added only when needed.",
                signal1: "Direct support for demos, onboarding and questions",
                signal2: "Fast product development from real customer feedback",
                signal3: "Support when switching from existing tools",
                contact: "Get in touch",
                about: "About Chrono-Logisch",
            },
            trust: {
                title: "Trust for daily work in CH & DE",
                transportLabel: "Transport",
                transportValue: "TLS & HSTS",
                accessLabel: "Access",
                accessValue: "Roles & permissions",
                privacyLabel: "Privacy",
                privacyValue: "revFADP & GDPR",
                exportLabel: "Data",
                exportValue: "Export defined",
            },
            outcomes: {
                kicker: "Three clear starting points",
                title: "Which task is costing you time today?",
                lead: "Chrono starts with a concrete problem — not the longest possible module list.",
                beforeLabel: "Today",
                afterLabel: "With Chrono",
                time: {
                    title: "Working time without spreadsheets",
                    before: "Collect hours from lists, corrections and follow-up questions.",
                    after: "Capture once and review actual/target time, balances and corrections centrally.",
                },
                leave: {
                    title: "Leave without follow-ups",
                    before: "Clarify requests, balances and cover across several channels.",
                    after: "Keep requests, overview and approval in one traceable workflow.",
                },
                payroll: {
                    title: "Payroll preparation without double entry",
                    before: "Transfer time and absence data again for the payroll run.",
                    after: "Reuse reviewed data from the same system for payroll.",
                },
            },
            security: {
                kicker: "Security & privacy",
                title: "Clear measures instead of blanket promises.",
                lead: "For sensitive HR and payroll data, what matters is what is technically and contractually defined.",
                privacyCta: "View privacy notice",
                termsCta: "Terms & data export",
                transport: {
                    title: "Encrypted transport",
                    text: "TLS and HSTS protect the connection between the browser and Chrono.",
                },
                access: {
                    title: "Role-based access",
                    text: "Roles, page permissions and administrative access are controlled separately.",
                },
                contract: {
                    title: "Privacy contractually defined",
                    text: "revFADP and GDPR are addressed; a DPA is provided where Chrono processes data on behalf of a customer.",
                },
                export: {
                    title: "Data remains exportable",
                    text: "Data export during the contract and handling after termination are described in the terms.",
                },
            },
            social: {
                title: "Trusted by teams in CH & DE",
                note: "Chrono documents privacy, roles, data export and technical safeguards transparently.",
                hotel: "Hospitality",
            ...
            features: {
                kicker: "Core & extensions",
                title: "From the core workflow to the right extension.",
                lead: "Time, team and approvals form the core. Other areas are clearly marked as available or on request.",
                aria: "Chrono module overview",
                map: {
                    flowLabel: "Module compass",
                    flowTitle: "Foundation first, extensions after.",
                    flowText: "Time & team start the process. Other modules use the same data base.",
                    facts: {
                        coreLabel: "Core",
                        coreValue: "time, team, permissions",
                        dataLabel: "Data",
                        dataValue: "capture once, use many times",
                        addonLabel: "Add-ons",
                        addonValue: "activate only what is needed",
                    },
                    relationLabel: "Short logic",
                    relationTitle: "What do you need to know?",
                    relationText: "One platform, several optional areas.",
                    flow: {
                        setup: {
                            title: "Setup",
                            text: "Permissions, models, modules",
                        },
                        time: {
                            title: "Time & planning",
                            text: "Time & absences",
                        ...
                        finance: {
                            ...
                            text: "Payroll & payment",
                        },
                        operations: {
                            title: "Operations & goods",
                            text: "Goods flow & service",
                        },
                    },
                    clusters: {
                        core: {
                    ...
                    modules: {
                        ...
                        schedule: "Schedule",
                        absences: "Leave & absences",
                        userManagement: "User management",
                        projects: "Customers, projects & tasks",
                        crm: "CRM & marketing",
                        analytics: "Analytics & reports",
                        payslips: "Payslips",
                        accounting: "Financial accounting",
                        banking: "Payment traffic",
                        supplyChain: "Supply chain",
                        purchase: "Purchasing",
                        sales: "Sales",
                        service: "Service",
                        ...
                        chronoTwo: "Chrono 2.0",
                        pms: "Hotel management (PMS)",
                    },
                    status: {
                        base: "Core",
                        available: "Available",
                        onRequest: "On request",
                        finalDevelopment: "In final development",
                    },
                    notes: {
                        user: "User",
                        admin: "Admin",
                    ...
                    relations: {
                        one: "Setup defines permissions, work models and active modules.",
                        two: "Time data is reviewed and reused directly.",
                        three: "Projects, payroll, CRM and supply chain share the same data base.",
                    },
                },
                real: {
                    dashboard: {
                        label: "Dashboard",
                        title: "Time tracking & weekly overview",
                        text: "Real user dashboard with clocking, planned vs actual hours, weekly balance, day cards and corrections.",
                    },
                    users: {
                        label: "Team & permissions",
                        title: "User management",
                        text: "Manage employees, roles, accessible pages and work models.",
                    },
                    schedule: {
                        label: "Planning",
                        title: "Schedule",
                        text: "Plan shifts, print weeks and prepare assignments cleanly.",
                    },
                    payslips: {
                        label: "Payroll",
                        title: "Payslips",
                        text: "Provide payroll documents and employee files.",
                    },
                    projects: {
                        label: "Customer work",
                        title: "Customers, projects & tasks",
                        text: "Connect customers, projects and tasks with booked hours.",
                    },
                    accounting: {
                        label: "Accounting",
                        title: "Financial accounting",
                        text: "Bundle receipts, postings and exports for finance processes.",
                    },
                    banking: {
                        label: "Banking",
                        title: "Payment traffic",
                        text: "Prepare, review and approve payments for banking workflows.",
                    },
                    crm: {
                        label: "Pipeline",
                        title: "CRM & marketing",
                        text: "Manage leads, customer contacts and the CRM pipeline.",
                    },
                    supply: {
                        label: "Stock",
                        title: "Supply chain",
                        text: "Keep stock, movements, purchasing, sales and service in view.",
                    },
                    knowledge: {
                        label: "Knowledge",
                        title: "Company knowledge",
                        text: "Provide documents, policies and internal knowledge centrally.",
                    },
                    chronoTwo: {
                        label: "Add-on module",
                        title: "Chrono 2.0",
                        text: "Additional Chrono processes and new functions as a dedicated module.",
                    },
                    settings: {
                        label: "Setup",
                        title: "Company settings",
                        text: "Maintain company data, module access and global settings.",
                    },
                },
                tracking: {
                    label: "Core module",
                    ...
                    text: "Clock in via browser, NFC or app - directly on customer, project or job.",
                },
                leave: {
                    label: "Approvals",
                    ...
                    text: "Requests, balances, sickness and overtime in one clear workflow.",
                },
                payroll: {
                    label: "CH & DE",
                    title: "Payroll & finance",
                    ...
                    text: "Prepare, review and export payroll runs cleanly.",
                },
                reporting: {
                    label: "Analytics",
                    title: "Reports",
                    ...
                    text: "Planned vs actual, overtime and absences at a glance.",
                },
                teamwork: {
                ...
                reminders: {
                    ...
                    text: "Missing hours, reminders and approvals run together.",
                },
                security: {
                    label: "Secure",
                    title: "Security",
                    ...
                    text: "Roles, permissions and data access are clearly separated.",
                },
                access: {
                    label: "Mobile",
                    title: "Mobile-ready",
                    ...
                    text: "Chrono runs in the office, on the road, on tablets and phones.",
                },
                visual: {
                    clock: "Clock",
                    approval: "Approval",
                    ...
                    completeTimes: "times complete",
                    openApprovals: "3 approvals open",
                    payrollRun: "March payroll run",
                    readyReview: "Ready for review",
                    expectedShort: "Planned",
                    actualShort: "Actual",
                    absences: "Absences",
                ...
                ctaTitle: "Chrono grows with your company.",
                ctaText: "Start with the core of time, team and permissions - then unlock exactly the process areas your company really uses.",
                modulesCta: "View all modules",
            },
            showcase: {
                kicker: "Product feel",
                title: "How Chrono looks in daily work.",
                lead: "More than text: Chrono brings time, absences, payroll and operational processes into one shared interface.",
                time: {
                    title: "Time tracking",
                    text: "Clocking, corrections and customer hours in one clear daily flow.",
                    status: "Today",
                    detail: "38 employees active",
                },
                leave: {
                    title: "Leave",
                    text: "Requests, remaining days and absences are visible for teams and admins.",
                    status: "Approvals",
                    detail: "3 requests open",
                },
                payroll: {
                    title: "Payroll & finance",
                    text: "Payroll runs, exports and accounting closer to daily operations.",
                    status: "Payroll run",
                    detail: "ready for review",
                },
                week: {
                    title: "Weekly overview",
                    text: "This is what the real daily flow looks like in the user dashboard: clock times, planned vs actual hours and day cards.",
                },
                corrections: {
                    title: "Corrections",
                    text: "Correction requests appear in the dashboard as their own history with status and detail view.",
                },
            },
            dashboardPreview: {
                actual: "Actual time",
                expected: "Planned time",
                balance: "Week balance",
                monday: "Monday, 27 Apr",
                worked: "08:25 worked",
                clockIn: "Clock in",
                clockOut: "Clock out",
                correctionButton: "Request correction",
                correctionPanel: "Correction requests",
                openCorrections: "2 open",
                pending: "Open",
                approved: "Approved",
                correctionOne: "Change clock-out from 16:44 to 17:01",
                correctionTwo: "Forgotten lunch break added",
                vacationMonth: "April 2026",
                openVacation: "1 request open",
                vacationRequest: "Leave 02 May - 03 May",
                inReview: "in review",
                tag: "as in the dashboard",
            },
            steps: {
                kicker: "Start",
                title: "How to start with Chrono.",
                lead: "A transparent path from request to configured access.",
                register: {
                    title: "Configure your needs",
                    text: "Select team size and required areas. No automatic account is created yet.",
                },
                setup: {
                    title: "Set up access personally",
                    text: "We review the details, clarify questions and prepare the matching setup.",
                },
                start: {
                    title: "Start with your team",
                    text: "After activation, track time, approve absences and reuse reviewed data.",
                },
                link: "Request a demo",
            },
            calculator: {
                kicker: "Make effort visible",
                title: "What does today’s administration cost?",
                text: "Compare your estimated monthly administration effort with the Chrono base package.",
                employees: "Employees",
                minutes: "Admin minutes per person/week",
                rate: "Internal hourly rate (CHF)",
                currentCost: "Estimated current effort",
                chronoCost: "Chrono base from",
                hours: "hrs/month",
                perMonth: "per month",
                difference: "Calculated difference",
                disclaimer: "Orientation only, not a savings guarantee. Add-on modules and onboarding effort are not included.",
            },
            pms: {
                kicker: "New · In final development",
                heroBadge: "New PMS",
                heroStatus: "In final development",
                title: "Chrono Hotel Management (PMS)",
                text: "The new PMS brings reservations, room occupancy, guest data, housekeeping and billing together in Chrono. The core functions are ready; we are now preparing the system for productive hotel use together with pilot properties.",
                benefit1: "Manage reservations, arrivals and departures centrally",
                benefit2: "Coordinate room status and housekeeping live",
                benefit3: "Manage guests, services and invoices without duplicate entry",
                benefit4: "Personal support and direct product input as a pilot property",
                contactCta: "Test the PMS as a pilot property",
                registerCta: "Configure the PMS module",
                note: "Pilot places are limited and coordinated personally.",
                contactPrefill: "I am interested in pilot access to Chrono Hotel Management (PMS) and would like to test the system with my hotel.",
                previewLabel: "PMS dashboard preview",
                previewEyebrow: "Hotel operations today",
                previewTitle: "Front office overview",
                previewStatus: "Pilot",
                arrivals: "Arrivals",
                today: "today",
                occupancy: "Occupancy",
                ...
                cleaning: "Cleaning",
                arrival: "Arrival 15:00",
                ready: "Ready",
                priceLabel: "Launch price",
                price: "CHF 249",
                priceUnit: "per hotel / month, excl. VAT",
            },
            pricing: {
                kicker: "Pricing",
                title: "Modular from CHF 5 per employee.",
                text: "You only pay for the areas you actually need. More modules for leave, payroll, CRM or supply chain can be added later.",
                cta: "View pricing & start configuration",
                cardEyebrow: "Starter package",
                badge: "Popular start",
                cardPrice: "from CHF 5",
                cardUnit: "per employee / month",
                note: "Ideal for small teams, scalable monthly.",
                cardCta: "Start configuration",
                modules: {
                    time: "Time tracking",
                    leave: "Leave",
                    projects: "Projects",
                    ...
                    crm: "CRM / Supply Chain optional",
                    pms: "Hotel management (PMS) optional",
                },
            },
            faq: {
                kicker: "Chrono-Logisch",
                title: "In brief.",
                lead: "The key facts about Chrono-Logisch and its focused starting point.",
                what: {
                    question: "What is Chrono-Logisch?",
                    answer: "Chrono-Logisch is Swiss business software for time, absences and payroll preparation. Other areas are added modularly when needed.",
                },
                spelling: {
                    question: "Is Chrono-Logisch also written as \"Chrono logisch\"?",
                    answer: "Yes. Many people search for \"Chrono logisch\" or \"chrono logisch\". The official spelling is Chrono-Logisch.",
                },
            },
            contact: {
                kicker: "Demo & contact",
                ...
                send: "Send message",
                sending: "Sending...",
                hint: "Reply usually on the same business day.",
                signalsLabel: "Contact benefits",
                signal1: "Reply usually on the same business day",
                signal2: "Live demo with a real workflow",
                signal3: "Focus on teams in CH & DE",
            ...
            footer: {
                ...
                terms: "Terms",
                socialLabel: "Social media",
                linkedinLabel: "Christopher Siefert on LinkedIn",
                instagramLabel: "Chrono on Instagram",
            },
        ...
        registration: {
            success: {
                ...
                note: "If you need anything meanwhile, contact us at siefertchristopher@chrono-logisch.ch or +41 76 546 79 60.",
            ...
            modules: {
                ...
                pms: {
                    name: "Hotel management (PMS) (in final development)",
                    description: "Manage reservations, rooms, guests, housekeeping and billing centrally. For the first hotel property; pilot customers receive personal support.",
                },
            },
            pricing: {
                title: "Price overview",
                billingPeriodLabel: "Billing",
                billingPeriodAria: "Select billing period",
                monthly: "Monthly",
                yearly: "Yearly",
                yearlyPromo: "Pay yearly and get the first month free.",
                countryHint: "Prices for {{country}}",
                perEmployeeShort: "{{price}} / employee",
                flatShort: "{{price}} / month",
                perEmployeeShortMonthly: "{{price}} / employee / month",
                flatShortMonthly: "{{price}} / month",
                perEmployeeShortYearly: "{{price}} / employee / year",
                flatShortYearly: "{{price}} / year",
                perEmployeeDetail: "{{price}} × {{count}} employees",
                flatDetail: "{{price}} / month",
                perEmployeeDetailMonthly: "{{price}} × {{count}} employees",
                flatDetailMonthly: "{{price}} / month",
                perEmployeeDetailYearly: "{{price}} × {{count}} employees × {{months}} months",
                flatDetailYearly: "{{price}} × {{months}} months",
                total: "Total per month",
                totalMonthly: "Total per month",
                totalYearly: "Total per year",
                disclaimer: "All prices excl. VAT.",
                onRequest: "Price on request",
                onRequestDetail: "Pricing for this country is available on request.",
            },
            contact: {
        ...
        adminDashboard: {
            ...
            nextWeek: "Next Week",
            currentWeek: "Current Week",
            weekTabLabel: "Weekly view",
            monthTabLabel: "Monthly view",
            weekView: {
                allOptedOutWarning: "All known users are currently excluded from the time overviews. Adjust the \"Include in time tracking\" setting in user management to populate this view again.",
                actualThroughToday: "Actual (through today)",
                expectedThroughToday: "Target (through today)",
                balanceThroughToday: "Balance (through today)",
                balanceOpen: "Balance (not started)",
                currentHint: "Current week: actual, target and balance are calculated only through today.",
                futureHint: "This week is in the future and therefore has no balance yet.",
            },
            ...
            vacationCalendarAria: "Vacation calendar overview",
            forDate: "",
            ...
            originalTimeLabel: "Original",
            requestedTimeLabel: "Requested",
            noOriginalTimeLabel: "No original punch",
            ...
            commandPalette: {
                buttonLabel: "Commands (Ctrl+K)",
                placeholder: "Search command…",
                empty: "No matches",
                openVacations: "Open vacation center",
                openCorrections: "Open correction center",
                jumpToday: "Jump to current week",
                fixLowRisk: "Resolve ≤15 min items",
                focusUser: "Focus {{name}}",
            },
            shortcutCheatsheet: "Shortcuts: J/K=row · O=open · A=approve · D=deny · B=bulk select · /=search · G G=today · H/L=week ±",
            summary: {
                ariaLabel: "Current admin overview",
            },
            inboxSummary: {
                title: "Inbox status overview",
                subtitle: "See what needs attention today.",
                total: "Total open count",
                pendingLabel: "Open items",
                pendingDescription: "Everything waiting for your decision.",
                vacationsLabel: "Vacation requests",
                vacationsDescription: "Stay on top of absences.",
                correctionsLabel: "Correction requests",
                correctionsDescription: "Reconcile time changes quickly.",
            },
            inbox: {
                saveViewPrompt: "Save view as…",
                views: {
                    pending: "All open",
                    pendingHint: "Vacation + corrections · status open",
                    vacations: "Vacation center",
                    vacationsHint: "Show vacation requests only",
                    corrections: "Correction center",
                    correctionsHint: "Show correction requests only",
                    lowRisk: "≤15 min low-risk",
                    lowRiskHint: "Quickly approvable changes",
                    myDepartment: "My department",
                    myDepartmentHint: "Filter to my own team",
                    approved: "Approved",
                    approvedHint: "History of approved requests",
                    denied: "Denied",
                    deniedHint: "Keep track of denied requests",
                },
            },
            kpis: {
            ...
            actionStream: {
                ...
                emptyRow: "No items",
                searchPlaceholder: "Search (user, reason, date)…",
                bulkApprove: "Approve selection",
                bulkDeny: "Deny selection",
                approveLowRisk: "Approve low-risk",
                lowRisk: "Low risk",
                noLowRisk: "No low-risk corrections found.",
                ...
                summary: {
                    pending: "{{count}} open",
                    vacations: "{{count}} vacation requests",
            ...
            bulkDone: "{{count}} requests processed",
            ...
            onSickLeave: "Reported sick",
            sickWithEntries: "Time entries exist – please review.",
            halfDayNote: "Half-day vacation – review remaining time.",
            monthView: {
                modeLabel: "Range mode",
                modeCalendar: "Calendar month",
                modeCustomCycle: "Custom month boundaries",
                modeManual: "Select manually",
                customStartLabel: "Start day in month",
                startLabel: "Start date",
                endLabel: "End date",
                resetRange: "Reset month boundaries",
                currentRangeTitle: "Current range",
                noRangeSelected: "Please choose a valid range.",
                customCycleHint: "Automatic range: from the {day} of a month to the day before the same date in the next month.",
                manualHint: "Manual range – start and end stay fixed until you change them again.",
                adjustHint: "Default: 1st to last day of the month. Choose \"Custom month boundaries\" or \"Manual\" to analyse e.g. 26th to 26th.",
                invalidRange: "Please choose a valid range.",
                noUserData: "No user data for this range.",
                actualHours: "Actual (range)",
                expectedHours: "Target (range)",
            ...
            correctionModal: {
                ...
                hint: "Enter confirms · Shift+Enter adds a new line · Esc closes",
            },
        },
        adminAnalytics: {
        ...
        adminVacation: {
            ...
            multiPeriodHint: "Select a date range in the calendar. Add more periods in other months, then save them together.",
            periodsSaved: "Periods saved: {{count}}. You can add more vacations right away.",
            periodsPartiallySaved: "Periods saved: {{count}}. The remaining periods are still queued so you can retry saving them.",
            overlappingPeriods: "This period overlaps a vacation already in the queue.",
            halfDayOneDay: "Half-day vacation is only possible for a single day.",
            legendSaved: "Already saved",
            legendQueued: "Queued",
            addPeriod: "+ Add another period",
            queuedPeriods: "Queued periods",
            removePeriod: "Remove period",
            savePeriods: "Save periods",
            refreshError: "Change saved. The overview could not be refreshed yet.",
        ...
        payslips: {
            ...
            deleteApprovedError: "Approved payslips cannot be deleted. Reopen them first.",
            deleteError: "The payslip could not be deleted.",
            ...
            overtimeHours: "Overtime (hours:minutes)",
            invalidOvertimeTime: "Enter overtime as hours:minutes, for example 16:41.",
            billedOvertime: "Billed overtime",
            hoursUnit: "hrs",
        ...
        impressumPage: {
            title: "Imprint",
            kicker: "Contact & Provider",
            lead: "Here you will find the official company details for Chrono-Logisch, clearly presented and easy to reach for questions about contact, responsibility and collaboration.",
            updatedTag: "Legal status: May 2025",
            contactTag: "Replies by email or phone",
            locationTag: "Registered in Mogelsberg, Switzerland",
            introLabel: "At a glance",
            introText: "If you have questions about Chrono, collaboration opportunities or legal details, you will find the key provider and contact information here in a clear format.",
            providerEyebrow: "Company",
            providerTitle: "Provider",
            contactEyebrow: "Reachability",
            contactTitle: "Direct contact",
            responsibleEyebrow: "Content",
            responsibleTitle: "Responsible for content",
            liabilityEyebrow: "Notice",
            liabilityTitle: "Disclaimer",
            copyrightEyebrow: "Rights",
            copyrightTitle: "Copyright",
            quickContactKicker: "Quick access",
            quickContactTitle: "Best reached directly",
            quickContactText: "For questions about Chrono, partnerships or general enquiries, email or phone is usually the fastest way to reach us.",
            emailCta: "Send email",
            phoneCta: "Call now",
            ...
            responseText: "We usually get back to you as quickly as possible and handle your request personally.",
            noteTitle: "Transparency",
            noteText: "This imprint provides the legally required company details and is updated whenever relevant information changes.",
        ...
        privacyPage: {
            ...
            content: `
                ...
                <strong>Phone:</strong> <a href="tel:+41765467960">+41 76 546 79 60</a></p>
        ...
        agbPage: {
            title: "Terms and Conditions for the Chrono SaaS platform",
            kicker: "Legal & Trust",
            lead: "Your concise guide to how we deliver Chrono, protect data and handle payments, support and uptime.",
            updated: "Updated: 10 September 2025",
            summaryHint: "Highlights & essentials",
            highlightTitle: "Key takeaways",
            highlight1: "Trials end automatically – paid plans start only when you opt in.",
            highlight2: "Access may be paused for late payments, abuse or security risks.",
            highlight3: "Export data anytime; after cancellation we retain it for 30 days before deletion.",
            highlight4: "Swiss law applies; venue of jurisdiction is the provider's seat.",
            contactTitle: "Need help?",
            contactText: "Reach out via email or the ticket system – we'll get back to you as quickly as possible.",
            content: `
                <p class="legal-section legal-updated"><strong>Updated: 10 September 2025</strong></p>
                <ol>
                    <li>
                        <div class="legal-section">
                            <h3>Scope</h3>
                    ...
                    <li>
                        <div class="legal-section">
                            ...
                            <ul>
                                ...
                                <li>vacation and absence management</li>
                                <li>optional: payroll</li>
                                <li>optional: CRM, supply chain and inventory features</li>
                            </ul>
                            <p>The exact scope depends on the package booked. The provider may change, enhance or limit functions if the core functionality remains and changes are reasonable for the customer.</p>
                        </div>
                    </li>
                    <li>
                        <div class="legal-section">
                    ...
                    <li>
                        <div class="legal-section">
                            ...
                            <ul>
                                ...
                                <li>grant unauthorised access to third parties,</li>
