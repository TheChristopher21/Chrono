                ...
                {registration?.status === 'COMPLETED' ? (
                    ...
                    <>
                        ...
                        <form className="pms-form-grid" onSubmit={submit}>
                            ...
                            <label>{labelFor('Kennzeichen', 'vehiclePlate')}<input value={form.vehiclePlate} onChange={(event) => setForm({ ...form, vehiclePlate: event.target.value })} required={isRequired('vehiclePlate')} /></label>
