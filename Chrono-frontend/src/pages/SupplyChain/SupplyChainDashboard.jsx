...
const SupplyChainDashboard = () => {
    ...
    const workspaceDefinitions = [
        { id: "inbound", title: l("Wareneingänge", "Inbound"), subtitle: l("ASN, Tor, QS, Einlagerung", "ASN, dock, QC, putaway"), rows: inboundRows, columns: [{ key: "order", label: l("Auftrag", "Order") }, { key: "asn", label: "ASN" }, { key: "dock", label: l("Tor", "Dock") }, { key: "supplier", label: l("Lieferant", "Supplier") }, { key: "status", label: l("Status", "Status") }] },
            ...
            <main className="admin-content">
                <header className="hero-header card compact-hero">
                    <div className="header-text">
                        <h1>{l("Supply-Chain-Leitstand", "Supply Chain Enterprise Control Tower")}</h1>
